//
//  ConsulDetailAllergyViewController.h
//  ClubContact
//
...
@interface ConsulDetailAllergyViewController : BaseViewController <UITableViewDataSource, UITableViewDelegate> { IBOutlet UIImageView *profileIMG;
