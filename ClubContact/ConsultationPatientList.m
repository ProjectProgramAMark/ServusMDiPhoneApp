...
@interface ConsultationPatientList ()
{
    int currentPage;
}
...
@implementation ConsultationPatientList
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
   Patient *patientInfo = [_patientsArray objectAtIndex:indexPath.row];
    [[AppController sharedInstance] inviteConsultation:patientInfo.postid completion:^(BOOL success, NSString *message) {
        if (success) {
