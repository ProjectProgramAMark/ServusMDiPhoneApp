...
@property (nonatomic, retain) NSString *insurancecard;
@property (nonatomic, retain) NSString *insurancecardback;
@property (nonatomic, retain) NSString *idcard;
@property (nonatomic, retain) NSString *parentidcard;
