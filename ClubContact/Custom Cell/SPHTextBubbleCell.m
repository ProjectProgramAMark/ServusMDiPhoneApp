...
- (void)layoutSubviews
{
    ...
    if ([self.bubbletype isEqualToString:@"LEFT"])
    {
        ...
        //UIImage *coloredImage = [[UIImage imageNamed:@"messages_left_bubblenew.png"] maskWithColor:BLUE_TEXT_HIGHLIGHT_COLOR2];
    ...
    }else
    {
        ...
        // messageBackgroundView.image = [[UIImage imageNamed:@"messages_right_bubblenew.png"] stretchableImageWithLeftCapWidth:10 topCapHeight:5];
