...
@interface MSGPAllergyViewController ()

@end

@implementation MSGPAllergyViewController
...
- (void)getPatientAllergy {
    ...
    [[AppController sharedInstance] getAllAllergenByPMMaster2:patientID WithCompletion:^(BOOL success, NSString *message, NSMutableArray *conditions) {
