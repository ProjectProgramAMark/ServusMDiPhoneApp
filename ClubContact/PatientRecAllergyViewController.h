//
//  PatientRecAllergyViewController.h
//  ClubContact
//
...
@interface PatientRecAllergyViewController : BaseViewController <UITableViewDataSource, UITableViewDelegate> { IBOutlet UIImageView *profileIMG;
