...
@interface TalkDoctorViewController : BaseViewController <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate, UITabBarDelegate> {
...
@property (nonatomic) NSString *docSpecial;
