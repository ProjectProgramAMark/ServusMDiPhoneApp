...
NSString *const MJRefreshHeaderStateIdleText = @"Pull down to refresh";
NSString *const MJRefreshHeaderStatePullingText = @"Release to refresh";
NSString *const MJRefreshHeaderStateRefreshingText = @"Loading ...";

NSString *const MJRefreshFooterStateIdleText = @"Click to load more..";
NSString *const MJRefreshFooterStateRefreshingText = @"Loading...";
NSString *const MJRefreshFooterStateNoMoreDataText = @"Loaded";