//
//  AddEyeExamFormViewController.m
//  ClubContact
//
...
@interface AddEyeExamFormViewController ()

@end

@implementation AddEyeExamFormViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (catType == 0) {
        if (indexPath.section == 0) {
            cell.keyLabel.text = [self odAnteriorTitleByRow:indexPath.row];
            cell.valueLabel.text = [self odAnteriorValueByRow:indexPath.row];
            cell.valueLabel.tag = indexPath.row + 100;
        } else if (indexPath.section == 1) {
            cell.keyLabel.text = [self oSAnteriorTitleByRow:indexPath.row];
            cell.valueLabel.text = [self oSAnteriorValueByRow:indexPath.row];
            cell.valueLabel.tag = indexPath.row + 200;
        }
    } else if (catType == 1) {
        if (indexPath.section == 0) {
            cell.keyLabel.text = [self odPosteriorTitleByRow:indexPath.row];
            cell.valueLabel.text = [self odPosteriorValueByRow:indexPath.row];
            cell.valueLabel.tag = indexPath.row + 300;
        } else if (indexPath.section == 1) {
            cell.keyLabel.text = [self oSPosteriorTitleByRow:indexPath.row];
            cell.valueLabel.text = [self oSPosteriorValueByRow:indexPath.row];
            cell.valueLabel.tag = indexPath.row + 400;
        }
    } else if (catType == 2) {
        if (indexPath.section == 0) {
            cell.keyLabel.text = [self glassRX1TitleByRow:indexPath.row];
            cell.valueLabel.text = [self glassRX1ValueByRow:indexPath.row];
            cell.valueLabel.tag = indexPath.row + 500;
        } else if (indexPath.section == 1) {
            cell.keyLabel.text = [self glassRX2TitleByRow:indexPath.row];
            cell.valueLabel.text = [self glassRX2ValueByRow:indexPath.row];
            cell.valueLabel.tag = indexPath.row + 600;
        }
    } else if (catType == 3) {
        cell.keyLabel.text = [self contactsRXTitleByRow:indexPath.row];
        cell.valueLabel.text = [self contactsRXValueByRow:indexPath.row];
        cell.valueLabel.tag = indexPath.row + 700;
    } else if (catType == 4) {
        cell.keyLabel.text = [self additionalTestingTitleByRow:indexPath.row];
        cell.valueLabel.text = [self additionalTestingValueByRow:indexPath.row];
        cell.valueLabel.tag = indexPath.row + 800;
        
    } else if (catType == 5) {
        
        if (indexPath.section == 0) {
            cell.keyLabel.text = [self reccomendTitleByRow:indexPath.row];
            cell.valueLabel.text = [self reccomendValueByRow:indexPath.row];
            cell.valueLabel.tag = indexPath.row + 900;
        } else if (indexPath.section == 1) {
            cell.keyLabel.text = [self otherTitleByRow:indexPath.row];
            cell.valueLabel.text = [self otherValueByRow:indexPath.row];
            cell.valueLabel.tag = indexPath.row + 1000;
        }
    }
    ...
    /*if (indexPath.section == 0) {
      ...
      //  cell.valueLabel.text = [self odAnteriorTitleByRow:indexPath.row];
      ...
      //  cell.valueLabel.text = [self oSAnteriorTitleByRow:indexPath.row];
     ...
     //    cell.valueLabel.text = [self oSPosteriorTitleByRow:indexPath.row];
      ...
      //    cell.valueLabel.text = [self glassRX1TitleByRow:indexPath.row];
      ...
      //  cell.valueLabel.text = [self glassRX2TitleByRow:indexPath.row];
     ...
     //   cell.valueLabel.text = [self contactsRXTitleByRow:indexPath.row];
       ...
       //     cell.valueLabel.text = [self additionalTestingTitleByRow:indexPath.row];
      ...
      //  cell.valueLabel.text = [self reccomendTitleByRow:indexPath.row];
