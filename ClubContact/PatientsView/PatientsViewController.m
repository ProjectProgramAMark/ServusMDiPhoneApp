...
@interface PatientsViewController () <PatientsDetailDelegate, AddPatientiPhoneDelegate>
{
    int currentPage;
}
    ...
    if (IS_IPHONE) {
        if (self.shouldPatientSelect == true) {
          ...
          /*  UIBarButtonItem *cancelItem = [[UIBarButtonItem alloc]
           ...
           /* UIBarButtonItem *cancelButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"backarrow2"] style:UIBarButtonItemStylePlain target:self action:@selector(cancelPatientSelect)];*/
            UIBarButtonItem *cancelButton = [[UIBarButtonItem alloc] initWithTitle:@"Back" style:UIBarButtonItemStylePlain target:self action:@selector(cancelPatientSelect)];
            self.navigationItem.leftBarButtonItem = cancelButton;
        }
