//
//  MyProfileConditionsViewController.h
//  ClubContact
//
...
@interface MyProfileConditionsViewController : BaseViewController <UITableViewDataSource, UITableViewDelegate> { IBOutlet UIImageView *profileIMG;
