//
//  EditDoctoriPhoneViewController.m
//  ClubContact
//
...
@interface EditDoctoriPhoneViewController ()

@end

@implementation EditDoctoriPhoneViewController
...
- (void)viewDidLoad {
   ...
   /* UIBarButtonItem *cancelButton = [[UIBarButtonItem alloc]
    ...
    /*UIBarButtonItem *cancelButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"backarrow2"] style:UIBarButtonItemStylePlain target:self action:@selector(cancelDoctor)];*/
