...
-(void)commonInitializer {
    ...
    [_table registerNib:[UINib nibWithNibName:@"CalendarEventTableViewCell" bundle:nil] forCellReuseIdentifier:@"cell"];
    //[_table registerNib:[UINib nibWithNibName:@"CalendarNoEventTableViewCell" bundle:nil] forCellReuseIdentifier:@"noDataCell"];
    _table.backgroundColor = [UIColor colorWithRed:243.0f/255.0f green:243.0f/255.0f blue:243.0f/255.0f alpha:1.0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (count == 0) {
        ...
        cell.backgroundColor = [UIColor colorWithRed:243.0f/255.0f green:243.0f/255.0f blue:243.0f/255.0f alpha:1.0];
    ...
    [cell.profIMG setImageWithURL:[NSURL URLWithString:event.appointment.patientProfIMG]];
    
    cell.profIMG.layer.cornerRadius = cell.profIMG.frame.size.width/2;
    cell.profIMG.layer.masksToBounds = YES;
    cell.descLabel.text = [NSString stringWithFormat:@"%@ with %@ %@", @"Appointment", event.appointment.firstname, event.appointment.lastname];
    
    NSDate *dob = [NSDate dateWithTimeIntervalSince1970:[event.appointment.fromdate integerValue]];
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    [formatter setDateFormat:@"h:MM a"];
    cell.timeLabel.text = [NSString stringWithFormat:@"%@",[formatter stringFromDate:dob]];
