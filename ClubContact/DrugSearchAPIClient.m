...
@implementation DrugSearchAPIClient
...
- (void)searchForDrug:(NSString *)drugText completion:(DrugSearchResponseBlock)completion{
    NSString *urlString = [NSString stringWithFormat:@"%@/DispensableDrugs?callSystemName=Demo&searchText=%@", BASE_URL, drugText];
